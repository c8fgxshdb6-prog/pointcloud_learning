...
def train_pointnet2_msg():
    # MSG训练配置 - 优化参数
    config = {
        'data_path': '../data/modelnet40_ply_hdf5_2048',
        'batch_size': 12,        # MSG更耗内存，适当减小
        'num_points': 1024,      # 保持1024点，MSG已经能提取多尺度特征
        'epochs': 15,            # 增加epochs以获得更好性能
        'learning_rate': 0.001,
        'log_dir': 'logs_pointnet2_msg',
        'model': 'pointnet2_cls_msg'
    }
    
    print("🚀 Starting PointNet++ MSG Training")
    print("MSG Configuration:")
    ...
    # 创建MSG模型
    print("🔄 Creating PointNet++ MSG model...")
    ...
    print(f'🎉 MSG Training completed!')
